...
TIMELINE_EVENTS = [
    ...
    {"id": 4, "year": 2, "title": "Spring Break Road Trip", "description": "Rented a beat-up van and drove 12 hours to the coast. The van broke down. We didn't care.", "photo_urls": None},
    {"id": 5, "year": 2, "title": "Late-Night Study Sessions", "description": "Countless nights in the library basement — fuelled by coffee, despair, and someone's smuggled snacks.", "photo_urls": None},
    {"id": 6, "year": 2, "title": "University Festival", "description": "We ran a stall at the uni festival. It lost money. We gained memories.", "photo_urls": None},
    {"id": 7, "year": 3, "title": "House Share Begins", "description": "Moved into our first shared house. The boiler broke on day one. We called it home anyway.", "photo_urls": None},
    {"id": 8, "year": 3, "title": "Birthday Surprise", "description": "Pulled off a surprise birthday for one of us — complete with a cake that was 70% icing. She cried.", "photo_urls": None},
    {"id": 9, "year": 3, "title": "Summer Internships", "description": "We scattered across the country for internships. The group chat kept us going.", "photo_urls": None},
    {"id": 10, "year": 4, "title": "Final Year Project Madness", "description": "All-nighters, printer breakdowns, and last-minute panics. We somehow all graduated.", "photo_urls": None},
    {"id": 11, "year": 4, "title": "Graduation Day", "description": "Caps in the air, tears in our eyes, and one last group photo that still makes us smile.", "photo_urls": None},
    {"id": 12, "year": 4, "title": "Farewell Dinner", "description": "Our last dinner together as students. We promised to stay close — and we kept that promise.", "photo_urls": None},
]
...
UPDATES = [
    {"id": 1, "title": "Five Years Since Graduation", "content": "Can you believe it's been five years? We're planning a reunion this summer. Details coming soon!", "author": "Alex Chen", "posted_at": "2026-06-15"},
    ...
    {"id": 3, "title": "New Addition to the Squad", "content": "Big news — Maya and her partner just welcomed a baby girl! Little Sofia already has the whole group wrapped around her finger.", "author": "Priya Sharma", "posted_at": "2026-05-20"},
]

EVENTS_LIST = [
    {"id": 1, "title": "Summer Reunion 2026", "date": "2026-08-15", "description": "Our first official reunion at the old campus. Dinner, drinks, and a walk down memory lane.", "is_upcoming": True},
    {"id": 2, "title": "Beach Day", "date": "2026-09-10", "description": "A day at the beach — just like the old road trip. Bring snacks and sunscreen.", "is_upcoming": True},
    {"id": 3, "title": "New Year's Eve 2025", "date": "2025-12-31", "description": "Ring in the new year together, just like we used to.", "is_upcoming": False},
    {"id": 4, "title": "Graduation Anniversary Dinner", "date": "2025-07-04", "description": "Celebrating four years since we tossed our caps in the air.", "is_upcoming": False},
]
